...
import { UploadFilesController } from '../app/controllers/files/upload/upload-files.controller';
import { FileModelProvider } from './infraestructure/database/mongodb/mongo-file.provider';
...
import { GetFileStatusController } from '../app/controllers/files/query/get-file-status.controller';
